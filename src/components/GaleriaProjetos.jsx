...
//   // 🎬 Entrada inicial - OVERLAY PRIMEIRO
//   useEffect(() => {
//     if (isFirstMount.current) {
//       const fadeDelay = 0.8;
...
//       // OVERLAY PRIMEIRO - sem delay adicional
//       gsap.to(overlays, {
//         opacity: 0.7,
//         duration: 1.2,
//         ease: 'power2.out',
...
//       // IMAGENS DEPOIS - com um pequeno delay após o overlay
//       gsap.to(imagens, {
//         opacity: 1,
//         duration: 1.5,
//         ease: 'power2.out',
...
//   // FUNÇÃO: Reanima apenas o overlay do primeiro slide após filtro - MAIS RÁPIDO
